...
- **Cross-session messaging** — named local sessions can discover one another and exchange peer-authorized work (macOS / Linux / Windows x64 and arm64; see [docs](./docs/peer-messaging.en.md))
