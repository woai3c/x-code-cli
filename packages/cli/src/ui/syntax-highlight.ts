...
const JS_GLOBALS = new Set([
  'console', 'globalThis', 'window', 'document', 'process', 'module',
  'exports', 'require', '__dirname', '__filename', 'global', 'self',
  'Math', 'JSON', 'Symbol', 'Reflect', 'Atomics', 'Intl',
  'Object', 'Array', 'String', 'Number', 'Boolean', 'BigInt',
  'Date', 'RegExp', 'Error', 'TypeError', 'RangeError', 'SyntaxError',
  'ReferenceError', 'URIError', 'EvalError', 'AggregateError',
  'Promise', 'Map', 'Set', 'WeakMap', 'WeakSet', 'WeakRef', 'Proxy',
...
const KEYWORDS_JS = new Set([
  ...
  'let', 'new', 'of', 'package', 'private', 'protected', 'public', 'readonly', 'return',
  'set', 'static', 'super', 'switch', 'this', 'throw', 'try', 'type', 'typeof', 'var',
  'void', 'while', 'with', 'yield', 'as', 'declare', 'namespace', 'satisfies', 'override',
])
...
const KEYWORDS_SHELL = new Set([
  ...
  'done', 'function', 'in', 'return', 'exit', 'export', 'local', 'readonly', 'unset',
  'echo', 'printf', 'source',
])
